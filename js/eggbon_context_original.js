            ...
            switch (action) {
                ...
                case "copy":
                    ...
                    if (selectedComponent != null) {
                        var newComponent = selectedComponent.parent.createComponent(selectedComponent.type, false, false);
                        EggbonEditor.cloneComponentForContextAction(newComponent, selectedComponent );
                        EggbonEditor.clipBoard.set(newComponent);
                    }
                    return;
                    
                case "cut":
                    if (!this.canContextAction(action)) return;
                    if (selectedComponent.type == "popup") {
                ...
                case "paste":
                    if (!this.canContextAction(action)) return;
                    var newComponent = EggbonEditor.clipBoard.get();
                    if (!newComponent) return;
                    
                    newComponent.parent.addComponent(newComponent);
                    EggbonEditor.attchComponentForContextAction(newComponent);
